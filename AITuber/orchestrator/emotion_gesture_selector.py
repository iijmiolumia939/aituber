...
_RULES: list[tuple[frozenset[str], Emotion, list[Gesture]]] = [
    ...
    (
        frozenset(
            ["悲しい", "つらい", "ごめん", "ごめんね", "申し訳", "残念", "残念だな", "残念ながら"]
        ),
        Emotion.SAD,
        [Gesture.SHRUG, Gesture.SAD_IDLE],
    ),
    # ── Refusal / can't help ──────────────────────────────────────
    (
        frozenset(
            ["できないな", "できません", "わからない", "わからないな", "教えられない", "難しいね"]
        ),
        Emotion.NEUTRAL,
        [Gesture.SHRUG],
    ),
    ...
    (
        ...
        Emotion.HAPPY,
        [Gesture.LAUGH, Gesture.CHEER, Gesture.SIT_LAUGH],
    ),
    # ── Shy / embarrassed ─────────────────────────────────────────
    (
        frozenset(
            ["恥ずかしい", "はずかしい", "照れ", "てれ", "えへ", "もう", "やだ", "ドキドキ"]
        ),
        Emotion.HAPPY,
        [Gesture.SHY],
    ),
    ...
    (
        frozenset(["むり", "無理", "できない", "たいへん", "大変", "つらい", "厳しい", "きつい"]),
        Emotion.SAD,
        [Gesture.REJECTED, Gesture.SIGH],
    ),
    # ── Sigh / resignation ────────────────────────────────────────
    (
        frozenset(
            ["はぁ", "はあ", "ため息", "やれやれ", "ふぅ", "ふう", "まあいいか", "しょうがない"]
        ),
        Emotion.SAD,
        [Gesture.SIGH],
    ),
    # ── Thankful ──────────────────────────────────────────────────
    (
        frozenset(["ありがとう", "感謝", "うれしいな", "助かった", "おかげ", "よかった"]),
        Emotion.HAPPY,
        [Gesture.THANKFUL, Gesture.WAVE],
    ),
    # ── Pointing / explaining ─────────────────────────────────────
    (
        frozenset(
    ...
    (
        frozenset(
            ["おめでとう", "おめでとございます", "すばらしい", "素晴らしい", "パチパチ", "拍手"]
        ),
        Emotion.HAPPY,
        [Gesture.SIT_CLAP, Gesture.CHEER],
    ),
    # ── Disbelief / doubt ─────────────────────────────────────────
    (
        frozenset(
        ...
        Emotion.SURPRISED,
        [Gesture.SIT_DISBELIEF],
    ),
    # ── Frustrated / kick / rebellious ───────────────────────────
    (
        frozenset(["もう！", "むかつく", "イライラ", "腹立つ", "やめてよ", "ちょっと！"]),
        Emotion.SAD,
        [Gesture.SAD_KICK, Gesture.SIT_KICK],
    ),
    # ── Surprised (exclamation) ───────────────────────────────────
    (
        frozenset(
            ["すごい", "スゴイ", "すごっ", "ほんと！", "えええ", "うわ", "うわー", "さすが"]
        ),
        Emotion.SURPRISED,
        [Gesture.SURPRISED],
    ),
    ...
    (
        frozenset(
            ["考えてみよう", "そうかもしれない", "もしかしたら", "仮に", "例えば", "どうだろう"]
        ),
        Emotion.THINKING,
        [Gesture.THINKING],
    ),
